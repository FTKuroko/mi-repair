...
public class RepairOrderProcessor {
    ...
    public boolean process(StateMachineRepairOrder repairOrder, RepairOrderEvent repairOrderEvent) {
    ...
    private boolean sendEvent(Message<RepairOrderEvent> message) {
        StateMachineRepairOrder repairOrder = (StateMachineRepairOrder) message.getHeaders().get("repairOrder");
